...
class AnswerMarkdown(dspy.Signature):
    """Vais receber uma resposta do sistema e uma questão e a tua tarefa é fazer markdown da mesma, ou seja, sublinhares os aspetos mais importantes da resposta como artigos citados (com **), parágrafos (\n), e listas (-)"""
